	...
	return (
		...
		<section id='Description' ref={aboutMe}>
			<div className='DescriptionContainer'>
				<StyledH2>Développeur Web</StyledH2>
				<p>
					J'ai toujours développé pour le plaisir, mais après près de
					8 ans dans l'administration système et réseau, j'ai eu
					l'opportunité de me spécialisé dans le développement web.
					C'est pourquoi j'ai suivi une formation qui m'aura permis de
					parfaire toutes les compétences nécessaire à ce type de
					poste.
				</p>
			</div>
